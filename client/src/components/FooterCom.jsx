    ...
    <Footer container className='border border-t-8 border-teal-400'>
        ...
        <div className=" w-full max-w-7xl mx-auto">
          <div className="grid w-full justify-between sm:flex md:grid-cols-1">
            <Link to='/' className='self-center whitespace-normal text-lg sm:text-xl font-semibold dark:text-white'>
          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6 ">
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                ...
                <Footer.Link href='#' target='_blank' rel='noopener noreferrer' > Terms and Comditions </Footer.Link>
              </Footer.LinkGroup>
            </div>
          </div>
          ...
          <div className='w-full sm:flex sm:items-center sm:justify-between '>
            <Footer.Copyright href='#' by="CYBRSFER's Blog" year={new Date().getFullYear()}/>
